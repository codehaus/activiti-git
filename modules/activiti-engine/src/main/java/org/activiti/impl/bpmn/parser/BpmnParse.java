...
public class BpmnParse extends Parse {
  ...
  public void parseUserTask(Element userTaskElement, ScopeElementImpl scopeElement) {
    ...
    String formLanguage = userTaskElement.attributeNS(BpmnParser.BPMN_EXTENSIONS_NS, "form-language", ScriptingEngines.DEFAULT_EXPRESSION_LANGUAGE);
    if (form != null) {
      activity.setFormReference(new FormReference(form, formLanguage));
    }
  ...
  public void parseBoundaryTimerEventDefinition(Element timerEventDefinition, boolean interrupting, ActivityImpl timerActivity) {
    ...
    TimerDeclarationImpl timerDeclaration = timerActivity.getParent().createTimerDeclaration(businessCalendar, timeDurationText, TimerExecuteNestedActivityJobHandler.TYPE);
